...
- [ ] AC-005: Empty input shows error message
- [ ] AC-006: Whitespace-only input shows error message
- [ ] AC-007: Input exceeding 1000 characters shows error message

### View Tasks (AC)

- [ ] AC-008: All tasks display with ID, status, and content
- [ ] AC-009: Complete tasks show `[X]` marker
- [ ] AC-010: Incomplete tasks show `[ ]` marker
...
- [ ] AC-017: Empty new content shows error message
- [ ] AC-018: Whitespace-only new content shows error message
